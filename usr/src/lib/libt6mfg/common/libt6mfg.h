...
typedef enum {
	T6_MFG_ERR_OK	= 0,
	/*
	 * Indicates that a file descriptor argument was invalid. Generally,
	 * this means a value less than 0.
	 */
	T6_MFG_ERR_BAD_FD,
	/*
	 ...
	 * no current file descriptor associated with it.
	 */
	 ...
	 * The system error may be meaningful in this case for additional
	 * information.
	 */
...
typedef enum {
	...
	T6_MFG_FLASH_F_BS_VERS_INFO	= 1 << 1,
	T6_MFG_FLASH_F_EXP_VERS_INFO	= 1 << 2
