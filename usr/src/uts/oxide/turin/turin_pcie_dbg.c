 ...
 * turin_platform definition and consumed by code in zen/zen_fabric.c
 */
...
const zen_pcie_reg_dbg_t turin_pcie_core_dbg_regs[] = {
	...
	{
		.zprd_name = "PCIECORE::PCIE_HW_DEBUG_TXRCB_PORT",
		.zprd_def = D_PCIE_CORE_HW_DBG_TXRCB_PORT
	},
	{
	...
	{
		.zprd_name = "PCIECORE::PCIE_SDP_CTRL4",
		.zprd_def = D_PCIE_CORE_SDP_CTL4
	},
	{
		.zprd_name = "PCIECORE::PCIE_SDP_CTRL5",
		.zprd_def = D_PCIE_CORE_SDP_CTL5
	},
	{
		.zprd_name = "PCIECORE::PCIE_RCB_CNTL",
		.zprd_def = D_PCIE_CORE_RCB_CTL
	},
	{
	...
	{
		.zprd_name = "PCIECORE::PCIE_HW_DEBUG_RCB",
		.zprd_def = D_PCIE_CORE_HW_DBG_RCB
	},
	{
		.zprd_name = "PCIECORE::PCIE_HW_DEBUG_RCBRX_PORT",
		.zprd_def = D_PCIE_CORE_HW_DBG_RCBRX_PORT
	},
	{
	...
	{
		.zprd_name = "PCIECORE::CPM_CONTROL_EXT2",
		.zprd_def = D_PCIE_CORE_CPM_CTL_EXT2
	},
	{
	...
	{
		.zprd_name = "PCIECORE::CAC_MST_CTRL",
		.zprd_def = D_PCIE_CORE_CAC_MST_CTL
	},
	{
		.zprd_name = "PCIECORE::CAC_SLV_CTRL",
		.zprd_def = D_PCIE_CORE_CAC_SLV_CTL
	},
	{
	...
	{
		.zprd_name =
		    "PCIECORE::SMU_INT_PIN_SHARING_PORT_INDICATOR_FOUR",
		.zprd_def = D_PCIE_CORE_SMU_INT_PIN_SHARING4
	},
	{
		.zprd_name = "PCIECORE::PCIE_DYN_RECONFIG_PSEUDO_RESET",
		.zprd_def = D_PCIE_CORE_DYN_RECFG_PSEUDO_RST
	},
	{
	...
	{
		.zprd_name =
		    "PCIECORE::PCIE_PHYSICAL_PORT_WIDTH_0_MAPPING_STATUS",
		.zprd_def = D_PCIE_CORE_PHYS_PORT_WIDTH_0_MAPSTS
	},
	{
		.zprd_name =
		    "PCIECORE::PCIE_PHYSICAL_PORT_WIDTH_1_MAPPING_STATUS",
		.zprd_def = D_PCIE_CORE_PHYS_PORT_WIDTH_1_MAPSTS
	},
	{
	...
	{
		.zprd_name = "PCIECORE::PCIE_BUF_PORT0_MAPPING",
		.zprd_def = D_PCIE_CORE_BUF_PORT0_MAP
	},
	{
		.zprd_name = "PCIECORE::PCIE_BUF_PORT1_MAPPING",
		.zprd_def = D_PCIE_CORE_BUF_PORT1_MAP
	},
	{
		.zprd_name = "PCIECORE::PCIE_BUF_PORT2_MAPPING",
		.zprd_def = D_PCIE_CORE_BUF_PORT2_MAP
	},
	{
		.zprd_name = "PCIECORE::PCIE_BUF_PORT3_MAPPING",
		.zprd_def = D_PCIE_CORE_BUF_PORT3_MAP
	},
	{
		.zprd_name = "PCIECORE::PCIE_BUF_PORT4_MAPPING",
		.zprd_def = D_PCIE_CORE_BUF_PORT4_MAP
	},
	{
		.zprd_name = "PCIECORE::PCIE_BUF_PORT5_MAPPING",
		.zprd_def = D_PCIE_CORE_BUF_PORT5_MAP
	},
	{
		.zprd_name = "PCIECORE::PCIE_BUF_PORT6_MAPPING",
		.zprd_def = D_PCIE_CORE_BUF_PORT6_MAP
	},
	{
		.zprd_name = "PCIECORE::PCIE_BUF_PORT7_MAPPING",
		.zprd_def = D_PCIE_CORE_BUF_PORT7_MAP
	},
	{
		.zprd_name = "PCIECORE::PCIE_BUF_PORT8_MAPPING",
		.zprd_def = D_PCIE_CORE_BUF_PORT8_MAP
	},
	{
	...
	{
		.zprd_name = "PCIECORE::PCIE_ERR_HARVEST_RSP_STATUS",
		.zprd_def = D_PCIE_CORE_ERR_HARVEST_RSP_STS
	},
	{
		.zprd_name = "PCIECORE::SMU_PCIE_USB_MCM_ADDRESS",
		.zprd_def = D_PCIE_CORE_SMU_PCIE_USB_MCM_ADDRESS
	},
	{
	...
	{
		.zprd_name = "PCIECORE::LC_CPM_CONTROL_2",
		.zprd_def = D_PCIE_CORE_LC_CPM_CTL2
	},
	{
...
const zen_pcie_reg_dbg_t turin_pcie_port_dbg_regs[] = {
	...
	{
		.zprd_name = "PCIEPORT::PCIEP_RX_FC_DEBUG_P",
		.zprd_def = D_PCIE_PORT_RX_FC_DBG_P
	},
	{
		.zprd_name = "PCIEPORT::PCIEP_RX_FC_DEBUG_NP",
		.zprd_def = D_PCIE_PORT_RX_FC_DBG_NP
	},
	{
		.zprd_name = "PCIEPORT::PCIEP_RX_FC_DEBUG_CPL",
		.zprd_def = D_PCIE_PORT_RX_FC_DBG_CPL
	},
	{
		.zprd_name = "PCIEPORT::PCIE_CXL_QOS_CTRL1",
		.zprd_def = D_PCIE_PORT_CXL_QOS_CTL1
	},
	{
		.zprd_name = "PCIEPORT::PCIE_CXL_QOS_CTRL2",
		.zprd_def = D_PCIE_PORT_CXL_QOS_CTL2
	},
	{
		.zprd_name = "PCIEPORT::PCIE_CXL_QOS_CTRL3",
		.zprd_def = D_PCIE_PORT_CXL_QOS_CTL3
	},
	{
		.zprd_name = "PCIEPORT::PCIE_CXL_QOS_STATUS",
		.zprd_def = D_PCIE_PORT_CXL_QOS_STS
	},
	{
		.zprd_name = "PCIEPORT::PCIEP_CXL_ISO_CTRL_1",
		.zprd_def = D_PCIE_PORT_CXL_ISO_CTL1
	},
	{
		.zprd_name = "PCIEPORT::PCIEP_CXL_ISO_STATUS",
		.zprd_def = D_PCIE_PORT_CXL_ISO_STS
	},
	{
	...
	{
		.zprd_name = "PCIEPORT::PCIE_LC_ARBMUX_ERR_ISO_CNTL",
		.zprd_def = D_PCIE_PORT_LC_ARBMUX_ERR_ISO_CTL
	},
	{
	...
	{
		.zprd_name = "PCIEPORT::PCIE_TX_REPLAY_2",
		.zprd_def = D_PCIE_PORT_TX_REPLAY2
	},
	{
	...
	{
		.zprd_name = "PCIEPORT::PCIE_TX_CREDIT_RELEASE",
		.zprd_def = D_PCIE_PORT_TX_CREDIT_RELEASE
	},
	{
	...
	{
		.zprd_name = "PCIEPORT::PCIE_MST_PORT_CTRL_1",
		.zprd_def = D_PCIE_PORT_MST_PORT_CTL1
	},
	{
