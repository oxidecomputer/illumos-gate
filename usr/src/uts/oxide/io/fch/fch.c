...
static const fch_def_t fch_defs[] = {
	...
	/*
	 * XXX These macros (e.g., ZEN_IOPORT_COMPAT_BASE) should really be
...
fch_ioms_cb(zen_ioms_t *ioms, void *arg)
{
	...
	const smn_reg_t enreg = zen_iodie_reg(iodie, D_FCH_PMIO_ALTMMIOEN, 0);
	const smn_reg_t bar = zen_iodie_reg(iodie, D_FCH_PMIO_ALTMMIOBASE, 0);
	memlist_t *ioml, *mmml;
