...
/*
 * This file contains Ruby-specific data structures that are required for MPIO.
 *
 ...
 * expect them.
 *
 * PORT	REV	PHYS		DXIO		1P BUS
 * P0	0	0   (0x00)	0   (0x00)	e0
 * G0	1	96  (0x60)	96  (0x60)	a0
 * P1	0	32  (0x20)	32  (0x20)	c0
 * G1	1	64  (0x40)	64  (0x40)	80
 * P2	1	48  (0x30)	48  (0x30)	0
 * G2	0	112 (0x70)	112 (0x70)	40
 * P3	1	16  (0x10)	16  (0x10)	60
 * G3	0	80  (0x50)	80  (0x50)	20
 * P4	0	128 (0x80)	128 (0x80)	a0
 * P5	0	132 (0x84)	132 (0x84)	a0
 *
...
#define	SP5_PHY_OFFSET_P4	128
#define	SP5_PHY_OFFSET_P5	132
...
const zen_mpio_ask_port_t ruby_mpio_pcie_s0[] = {
    ...
    { /* P4, M.2 x4 */
	.zma_link = {
	    .zml_lane_start = SP5_PHY_OFFSET_P4,
	    .zml_num_lanes = 4,
	    .zml_ctlr_type = ZEN_MPIO_ASK_LINK_PCIE,
	    .zml_gpio_id = 1,
	    .zml_attrs = {
    ...
    { /* P5, M.2 (1/2) */
	.zma_link = {
	    .zml_lane_start = SP5_PHY_OFFSET_P5,
	    .zml_num_lanes = 1,
	    .zml_ctlr_type = ZEN_MPIO_ASK_LINK_PCIE,
	    .zml_gpio_id = 1,
	    .zml_attrs = {
    ...
    { /* P5, M.2 (2/2) */
	.zma_link = {
	    .zml_lane_start = SP5_PHY_OFFSET_P5 + 1,
	    .zml_num_lanes = 1,
	    .zml_ctlr_type = ZEN_MPIO_ASK_LINK_PCIE,
	    .zml_gpio_id = 1,
	    .zml_attrs = {
    ...
    { /* P5, NIC */
	.zma_link = {
	    .zml_lane_start = SP5_PHY_OFFSET_P5 + 3,
	    .zml_num_lanes = 1,
	    .zml_ctlr_type = ZEN_MPIO_ASK_LINK_PCIE,
	    .zml_gpio_id = 1,
	    .zml_attrs = {
...
const zen_mpio_ubm_hfc_port_t ruby_mpio_hfc_ports_full_nvme[] = {
	...
	.zmuhp_start_lane = SP5_PHY_OFFSET_P0,
	.zmuhp_ubm_device = {
	...
	.zmuhp_start_lane = SP5_PHY_OFFSET_G0,
	.zmuhp_ubm_device = {
	    .zmud_bp_type_bitno = 0,
	    .zmud_i2c_reset_bitno = 1,
	    .zmud_slot_num = 0x14,
	...
	.zmuhp_start_lane = SP5_PHY_OFFSET_G1,
	.zmuhp_ubm_device = {
	...
	.zmuhp_start_lane = SP5_PHY_OFFSET_G2,
	.zmuhp_ubm_device = {
	...
	.zmuhp_start_lane = SP5_PHY_OFFSET_P3,
	.zmuhp_ubm_device = {
	    .zmud_bp_type_bitno = 2,
	    .zmud_i2c_reset_bitno = 3,
	    .zmud_slot_num = 0x20,
	...
	.zmuhp_start_lane = SP5_PHY_OFFSET_G3,
	.zmuhp_ubm_device = {
...
const zen_mpio_ubm_hfc_port_t ruby_mpio_hfc_ports_full_sata[] = {
	...
	.zmuhp_start_lane = SP5_PHY_OFFSET_G3 + 8,
	.zmuhp_ubm_device = {
	    .zmud_bp_type_bitno = 4,
	    .zmud_i2c_reset_bitno = 5,
	    .zmud_slot_num = 0,
