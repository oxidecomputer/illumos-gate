...
#define	TURIN_SMU_FEATURE_PCIE_SPEED_CONTROLLER			(1U << 26)
...
/*
 * Entry point for setting SMU features on Turin.
 */
extern void turin_smu_features_init(zen_iodie_t *);

/*
 * SMU argument, request, and response register definitions for Turin.
 */
