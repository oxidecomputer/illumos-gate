...
#ifndef _SYS_IO_TURIN_MPIO_IMPL_H
#define	_SYS_IO_TURIN_MPIO_IMPL_H

#include <sys/io/turin/mpio.h>

/*
 * Types, definitions, function prototypes, etc, specific to the Turin
...
extern void turin_set_mpio_global_config(zen_mpio_global_config_t *);

#ifdef __cplusplus
}
#endif

#endif /* _SYS_IO_TURIN_MPIO_IMPL_H */
