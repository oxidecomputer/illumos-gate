 ...
 * G1 R   64/16     1    1     0/2         0x80   1     PCIE1  3/[7:1], 4/[2:1]
 * P2 R   48/16     2    0     1/0         0x40   0     PCIE0  1/[7:1], 2/[2:1]
 * G2    112/16     2    1     1/1         0x60   0     PCIE1  3/[7:1], 4/[2:1]
 * P3 R   16/16     3    0     1/3         0xe0   1     PCIE0  1/[7:1], 2/[2:1]
 * G3     80/16     3    1     1/2         0xc0   1     PCIE1  3/[7:1], 4/[2:1]
 * P4    128/4      2    2     1/4         0x80   1     PCIE2  5/[4:1]
 * P5    132/4      0    2     0/4         0xc0   0     PCIE2  5/[4:1]
 */
...
#define	PCIE_PORT_LC_PRST_MASK_CTL_16GT_VAL	\
    ...
    PCIE_PORT_LC_PRST_MASK_CTL_P(5) | \
    PCIE_PORT_LC_PRST_MASK_CTL_P(6) | \
    PCIE_PORT_LC_PRST_MASK_CTL_P(8) | \
...
#define	PCIE_CORE_RX_MARGIN_CTL_CAP(n, p)	\
    genoa_pcie_core_smn_reg((n), D_PCIE_CORE_RX_MARGIN_CTL_CAP, (p))
...
#define	PCIE_CORE_RX_MARGIN1(n, p)	\
    genoa_pcie_core_smn_reg((n), D_PCIE_CORE_RX_MARGIN1, (p))
...
#define	PCIE_CORE_RX_MARGIN2(n, p)	\
    genoa_pcie_core_smn_reg((n), D_PCIE_CORE_RX_MARGIN2, (p))
...
#define	PCIE_CORE_LC_DBG_CTL(n, p)	\
    genoa_pcie_core_smn_reg((n), D_PCIE_CORE_LC_DBG_CTL, (p))
