...
extern smn_reg_t genoa_iommu_mmio_reg(const zen_ioms_t *const,
    const smn_reg_def_t);
...
extern smn_reg_t genoa_pcie_core_reg(const zen_pcie_core_t *const,
    const smn_reg_def_t);
extern int genoa_pcie_port_eq(zen_pcie_port_t *, pcie_link_speed_t, uint32_t,
    pcie_eq_t *);
extern int genoa_pcie_port_set_preset_mask(zen_pcie_port_t *,
