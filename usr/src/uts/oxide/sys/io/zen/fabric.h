...
int zen_walk_ioms(zen_ioms_cb_f func, void *arg);
int zen_fabric_walk_pcie_core(zen_fabric_t *, zen_pcie_core_cb_f, void *);
int zen_fabric_walk_pcie_port(zen_fabric_t *, zen_pcie_port_cb_f, void *);
