...
struct zen_ioms {
	...
	uint8_t		zio_nnbifs;
	zen_pcie_core_t	*zio_pcie_cores;
	zen_nbif_t	*zio_nbifs;
	ioms_memlists_t	zio_memlists;
	zen_iodie_t	*zio_iodie;
};

typedef struct zen_dxio_impl zen_dxio_impl_t;;
...
struct zen_iodie {
	...
	zen_dxio_impl_t		*zi_dxio_impl;
	uint64_t		*zi_dpm_weights;
	zen_ioms_t		*zi_ioms;
	zen_ccd_t		*zi_ccds;
	zen_soc_t		*zi_soc;
};
