...
/*
 * These constants are taken from the RAS section of the Zen
 * documentation.
 */
...
enum zen_ras_mcax_bank_reg {
	...
	ZEN_RAS_MSR_MISC3,
	ZEN_RAS_MSR_MISC4,
	ZEN_RAS_MSR_RESERVEDE,
	ZEN_RAS_MSR_RESERVEDF,
	ZEN_RAS_MSR_BANK_NREGS,
};
CTASSERT(ZEN_RAS_MSR_BANK_NREGS == 16);

/*
 * Bits in RAS bank configuration registers.
 */
 ...
 */
static const uint_t ZEN_RAS_MASK_LS_SYS_RD_DATA_LD = 19;
static const uint_t ZEN_RAS_MASK_LS_SYS_RD_DATA_SCB = 20;
static const uint_t ZEN_RAS_MASK_LS_SYS_RD_DATA_WCB = 21;

/*
 * IF (instruction fetch) mask bits.
 */
static const uint_t ZEN_RAS_MASK_IF_L2_BTB_MULTI = 11;
static const uint_t ZEN_RAS_MASK_IF_L2_TLB_MULTI = 16;

/*
 * L2 mask bits.
 */
static const uint_t ZEN_RAS_MASK_L2_HWA = 3;

/*
 * FP (floating-point) mask bits.
 */
static const uint_t ZEN_RAS_MASK_FP_HWA = 6;

/*
 * CS (coherent slave - DF) mask bits.
 */
static const uint_t ZEN_RAS_MASK_CS_FTI_ADDR_VIOL = 1;

/*
 * L3 mask bits.
 */
static const uint_t ZEN_RAS_MASK_L3_HWA = 7;

/*
 * NBIO (northbridge I/O) mask bits.
 */
static const uint_t ZEN_RAS_MASK_NBIO_PCIE_SB = 1;
static const uint_t ZEN_RAS_MASK_NBIO_PCIE_ERR_EVT = 2;

/*
 * Entry point for initialization.
 */
void zen_ras_init(void);
