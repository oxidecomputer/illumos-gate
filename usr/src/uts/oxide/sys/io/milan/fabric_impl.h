...
extern bool milan_smu_pm_set_dram_addr(zen_iodie_t *, uint64_t);
extern bool milan_smu_pm_get_version(zen_iodie_t *, uint32_t *);
...
extern smn_reg_t milan_pcie_core_reg(const zen_pcie_core_t *const,
    const smn_reg_def_t);
extern int milan_pcie_port_eq(zen_pcie_port_t *, pcie_link_speed_t, uint32_t,
    pcie_eq_t *);
extern int milan_pcie_port_set_preset_mask(zen_pcie_port_t *,
