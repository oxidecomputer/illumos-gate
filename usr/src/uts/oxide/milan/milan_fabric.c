 ...
 */
static const zen_pcie_port_info_t milan_pcie0[ZEN_PCIE_CORE_MAX_PORTS] = {
	{ 0x1, 0x1 },
	{ 0x1, 0x2 },
	{ 0x1, 0x3 },
	{ 0x1, 0x4 },
...
static const zen_pcie_port_info_t milan_pcie1[ZEN_PCIE_CORE_MAX_PORTS] = {
	{ 0x3, 0x1 },
	{ 0x3, 0x2 },
	{ 0x3, 0x3 },
	{ 0x3, 0x4 },
...
static const zen_pcie_port_info_t milan_pcie2[ZEN_PCIE_CORE_WAFL_NPORTS] = {
	{ 0x5, 0x1 },
	{ 0x5, 0x2 }
};
...
static const zen_ioapic_info_t milan_ioapic_routes[IOAPIC_NROUTES] = {
	{ .zii_group = 0x0, .zii_map = 0x10,
	    .zii_swiz = IOAPIC_ROUTE_INTX_SWIZZLE_ABCD },
	{ .zii_group = 0x1, .zii_map = 0x11,
	    .zii_swiz = IOAPIC_ROUTE_INTX_SWIZZLE_ABCD },
	{ .zii_group = 0x2, .zii_map = 0x12,
	    .zii_swiz = IOAPIC_ROUTE_INTX_SWIZZLE_ABCD },
	{ .zii_group = 0x3, .zii_map = 0x13,
	    .zii_swiz = IOAPIC_ROUTE_INTX_SWIZZLE_ABCD },
	{ .zii_group = 0x4, .zii_map = 0x10,
	    .zii_swiz = IOAPIC_ROUTE_INTX_SWIZZLE_ABCD },
	{ .zii_group = 0x5, .zii_map = 0x11,
	    .zii_swiz = IOAPIC_ROUTE_INTX_SWIZZLE_ABCD },
	{ .zii_group = 0x6, .zii_map = 0x12,
	    .zii_swiz = IOAPIC_ROUTE_INTX_SWIZZLE_ABCD },
	{ .zii_group = 0x7, .zii_map = 0x13,
	    .zii_swiz = IOAPIC_ROUTE_INTX_SWIZZLE_ABCD },
	{ .zii_group = 0x7, .zii_map = 0x0c,
	    .zii_swiz = IOAPIC_ROUTE_INTX_SWIZZLE_CDAB },
	{ .zii_group = 0x6, .zii_map = 0x0d,
	    .zii_swiz = IOAPIC_ROUTE_INTX_SWIZZLE_CDAB },
	{ .zii_group = 0x5, .zii_map = 0x0e,
	    .zii_swiz = IOAPIC_ROUTE_INTX_SWIZZLE_CDAB },
	{ .zii_group = 0x4, .zii_map = 0x0f,
	    .zii_swiz = IOAPIC_ROUTE_INTX_SWIZZLE_CDAB },
	{ .zii_group = 0x3, .zii_map = 0x0c,
	    .zii_swiz = IOAPIC_ROUTE_INTX_SWIZZLE_CDAB },
	{ .zii_group = 0x2, .zii_map = 0x0d,
	    .zii_swiz = IOAPIC_ROUTE_INTX_SWIZZLE_CDAB },
	{ .zii_group = 0x1, .zii_map = 0x0e,
	    .zii_swiz = IOAPIC_ROUTE_INTX_SWIZZLE_CDAB },
	{ .zii_group = 0x0, .zii_map = 0x0f,
	    .zii_swiz = IOAPIC_ROUTE_INTX_SWIZZLE_CDAB },
	{ .zii_group = 0x0, .zii_map = 0x08,
	    .zii_swiz = IOAPIC_ROUTE_INTX_SWIZZLE_DABC },
	{ .zii_group = 0x1, .zii_map = 0x09,
	    .zii_swiz = IOAPIC_ROUTE_INTX_SWIZZLE_DABC },
	{ .zii_group = 0x2, .zii_map = 0x0a,
	    .zii_swiz = IOAPIC_ROUTE_INTX_SWIZZLE_DABC },
	{ .zii_group = 0x3, .zii_map = 0x0b,
	    .zii_swiz = IOAPIC_ROUTE_INTX_SWIZZLE_DABC },
	{ .zii_group = 0x4, .zii_map = 0x08,
	    .zii_swiz = IOAPIC_ROUTE_INTX_SWIZZLE_DABC },
	{ .zii_group = 0x5, .zii_map = 0x09,
	    .zii_swiz = IOAPIC_ROUTE_INTX_SWIZZLE_DABC }
};

static const zen_nbif_info_t milan_nbif0[ZEN_NBIF0_NFUNCS] = {
...
static const zen_nbif_info_t milan_nbif1[ZEN_NBIF1_NFUNCS] = {
	{ .zni_type = ZEN_NBIF_T_DUMMY, .zni_dev = 0, .zni_func = 0 },
...
static const zen_nbif_info_t milan_nbif2[ZEN_NBIF2_NFUNCS] = {
	{ .zni_type = ZEN_NBIF_T_DUMMY, .zni_dev = 0, .zni_func = 0 },
	{ .zni_type = ZEN_NBIF_T_NTB, .zni_dev = 0, .zni_func = 1 },
...
/*
 * The following table encodes the mapping of the set of dxio
...
typedef struct milan_dxio_impl {
...
static boolean_t milan_smu_rpc_read_brand_string(zen_iodie_t *,
    char *, size_t);

/*
 * Our primary global data. This is the reason that we exist.
 */
static zen_fabric_t milan_fabric;
...
milan_fabric_thread_get_brandstr(const zen_thread_t *thread,
    char *buf, size_t len)
{
	zen_soc_t *soc = thread->zt_core->zc_ccx->zcx_ccd->zcd_iodie->zi_soc;
	return (snprintf(buf, len, "%s", soc->zs_brandstr));
}
...
{
	zen_iodie_t *iodie = thread->zt_core->zc_ccx->zcx_ccd->zcd_iodie;
	*wp = iodie->zi_dpm_weights;
...
{
	uint64_t ecam = milan_fabric.zf_ecam_base;
...
static uint32_t
milan_df_read32(zen_iodie_t *iodie, uint8_t inst, const df_reg_def_t def)
{
	uint32_t val = 0;
	...
	pci_putl_func(0, iodie->zi_dfno, ficaa.drd_func, ficaa.drd_reg, val);
	val = pci_getl_func(0, iodie->zi_dfno, ficad.drd_func, ficad.drd_reg);
 ...
 * locking being used as the purpose of zi_df_ficaa_lock is just to ensure
 * there's only one use of it at any given time.
 */
static uint32_t
milan_df_bcast_read32(zen_iodie_t *iodie, const df_reg_def_t def)
{
	ASSERT0(def.drd_reg & 3);
	return (pci_getl_func(0, iodie->zi_dfno, def.drd_func, def.drd_reg));
}

static void
milan_df_bcast_write32(zen_iodie_t *iodie, const df_reg_def_t def,
    uint32_t val)
{
	ASSERT0(def.drd_reg & 3);
	pci_putl_func(0, iodie->zi_dfno, def.drd_func, def.drd_reg, val);
}
...
milan_smn_read(zen_iodie_t *iodie, const smn_reg_t reg)
{
	...
	case 2:
		...
		break;
	case 4:
		val = pci_getl_func(iodie->zi_smn_busno, AMDZEN_NB_SMN_DEVNO,
    ...
    const smn_reg_def_t def)
{
	...
	case SMN_UNIT_NBIF_FUNC:
		reg = milan_nbif_func_smn_reg(ioms->zio_num, def,
		    nbif->zn_nbifno, func->zne_dev, func->zne_func);
		break;
	default:
...
{
	return (milan_smn_read(func->zne_nbif->zn_ioms->zio_iodie, reg));
}
...
milan_nbif_func_write(zen_nbif_func_t *func, const smn_reg_t reg,
    const uint32_t val)
{
	milan_smn_write(func->zne_nbif->zn_ioms->zio_iodie, reg, val);
}
...
milan_pcie_populate_core_dbg(zen_pcie_core_t *pc, void *arg)
{
	...
	milan_pcie_dbg_t *dp = pc->zpc_dbg;

	if (dp == NULL)
		return (0);

	if (iodie_match != MILAN_IODIE_MATCH_ANY &&
	    iodie_match != pc->zpc_ioms->zio_iodie->zi_node_id) {
		return (0);
	}
...
milan_pcie_populate_port_dbg(zen_pcie_port_t *port, void *arg)
{
	milan_pcie_config_stage_t stage = milan_pcie_dbg_cookie_to_stage(arg);
	uint8_t iodie_match = milan_pcie_dbg_cookie_to_iodie(arg);
	milan_pcie_dbg_t *dp = port->zpp_dbg;

	if (dp == NULL)
		return (0);

	if (iodie_match != MILAN_IODIE_MATCH_ANY &&
	    iodie_match != port->zpp_core->zpc_ioms->zio_iodie->zi_node_id) {
		return (0);
	}
...
milan_fabric_ioms_pcie_init(zen_ioms_t *ioms)
{
	for (uint_t pcno = 0; pcno < ioms->zio_npcie_cores; pcno++) {
		...
		const zen_pcie_port_info_t *pinfop = NULL;
		...
		if (pcno == MILAN_IOMS_WAFL_PCIE_CORENO) {
			...
			cinfop = &milan_lane_maps[ioms->zio_num * 2 + pcno];
		}

		pc->zpc_dxio_lane_start = cinfop->zpci_dxio_start;
		pc->zpc_dxio_lane_end = cinfop->zpci_dxio_end;
		pc->zpc_phys_lane_start = cinfop->zpci_phy_start;
		pc->zpc_phys_lane_end = cinfop->zpci_phy_end;
		...
		for (uint_t portno = 0; portno < pc->zpc_nports; portno++) {
			...
			port->zpp_core = pc;
			port->zpp_device = pinfop[portno].zppi_dev;
			port->zpp_func = pinfop[portno].zppi_func;
			port->zpp_hp_type = ZEN_FW_HP_INVALID;
		}
	}
}
...
milan_fabric_ioms_nbif_init(zen_ioms_t *ioms)
{
	for (uint_t nbifno = 0; nbifno < ioms->zio_nnbifs; nbifno++) {
		const zen_nbif_info_t *ninfo = NULL;
		...
		switch (nbifno) {
		case 0:
			nbif->zn_nfuncs = ZEN_NBIF0_NFUNCS;
			ninfo = milan_nbif0;
			break;
		case 1:
			nbif->zn_nfuncs = ZEN_NBIF1_NFUNCS;
			ninfo = milan_nbif1;
			break;
		case 2:
		...
		for (uint_t funcno = 0; funcno < nbif->zn_nfuncs; funcno++) {
			...
			func->zne_nbif = nbif;
			func->zne_type = ninfo[funcno].zni_type;
			func->zne_dev = ninfo[funcno].zni_dev;
			func->zne_func = ninfo[funcno].zni_func;

			/*
			 * As there is a dummy device on each of these, this in
			 * theory doesn't need any explicit configuration.
			 */
			if (func->zne_type == ZEN_NBIF_T_DUMMY) {
				func->zne_flags |= ZEN_NBIF_F_NO_CONFIG;
			}
		}
	}
}
...
static void
milan_smu_rpc(zen_iodie_t *iodie, milan_smu_rpc_t *rpc)
{
	uint32_t resp;
...
static boolean_t
milan_smu_rpc_start_hotplug(zen_iodie_t *iodie, boolean_t one_based,
    uint8_t flags)
{
	milan_smu_rpc_t rpc = { 0 };
 ...
 */
static boolean_t
milan_smu_rpc_read_brand_string(zen_iodie_t *iodie, char *buf, size_t len)
{
	milan_smu_rpc_t rpc = { 0 };
	uint_t off;
...
{
	milan_dxio_config_t *conf = iodie->zi_iofw_impl;
	milan_dxio_rpc_t rpc = { 0 };
...
milan_dump_versions(zen_iodie_t *iodie, void *arg)
{
	...
	if (milan_smu_rpc_get_version(iodie, &maj, &min, &patch)) {
		...
		iodie->zi_smu_fw[0] = maj;
		iodie->zi_smu_fw[1] = min;
		iodie->zi_smu_fw[2] = patch;
	} else {
	...
	if (milan_dxio_rpc_get_version(iodie, &dxmaj, &dxmin)) {
		...
		iodie->zi_dxio_fw[0] = dxmaj;
		iodie->zi_dxio_fw[1] = dxmin;
	} else {
...
milan_ccx_init_core(zen_ccx_t *ccx, uint8_t lidx, uint8_t pidx)
{
	...
	VERIFY3U(SCFCTP_PMREG_INITPKG0_GET_PHYS_DIE(val), ==,
	    ccx->zcx_ccd->zcd_physical_dieno);
...
{
	const zen_fabric_t *fabric = soc->zs_fabric;
	...
	for (uint8_t ccdpno = 0, lccd = 0;
		 ...
		 */
		ccd->zcd_ccm_fabric_id = ccd->zcd_ccm_comp_id |
		    (iodie->zi_node_id << fabric->zf_node_shift);
...
milan_fabric_topo_init(void)
{
	...
	zen_fabric_t *fabric = &milan_fabric;
	...
	fabric->zf_node_mask = DF_FIDMASK0_V3_GET_NODE_MASK(fidmask);
	fabric->zf_comp_mask = DF_FIDMASK0_V3_GET_COMP_MASK(fidmask);

	fidmask = milan_df_early_read32(DF_FIDMASK1_V3);
	fabric->zf_node_shift = DF_FIDMASK1_V3_GET_NODE_SHIFT(fidmask);
	...
	for (uint8_t socno = 0; socno < nsocs; socno++) {
		...
		iodie->zi_dfno = AMDZEN_DF_FIRST_DEVICE + socno;

		nodeid = pci_getl_func(AMDZEN_DF_BUSNO, iodie->zi_dfno,
		    rd.drd_func, rd.drd_reg);
		iodie->zi_node_id = DF_SYSCFG_V3_GET_NODE_ID(nodeid);
		iodie->zi_soc = soc;
		...
		iodie->zi_smn_busno = DF_CFG_ADDR_CTL_GET_BUS_NUM(busno);

		iodie->zi_nioms = MILAN_IOMS_PER_IODIE;
		...
		for (uint8_t iomsno = 0; iomsno < iodie->zi_nioms; iomsno++) {
			...
			ioms->zio_comp_id = MILAN_DF_FIRST_IOMS_ID + iomsno;
			ioms->zio_fabric_id = ioms->zio_comp_id |
			    (iodie->zi_node_id << fabric->zf_node_shift);

			val = milan_df_read32(iodie, ioms->zio_comp_id,
			    DF_CFG_ADDR_CTL_V2);
			ioms->zio_pci_busno = DF_CFG_ADDR_CTL_GET_BUS_NUM(val);
		...
		if (!milan_smu_rpc_read_brand_string(iodie, soc->zs_brandstr,
		    sizeof (soc->zs_brandstr))) {
			soc->zs_brandstr[0] = '\0';
		}

		if (!milan_smu_rpc_read_dpm_weights(iodie,
		    iodie->zi_dpm_weights, sizeof (iodie->zi_dpm_weights))) {
			/*
			 * XXX It's unclear whether continuing is wise.
			 */
			cmn_err(CE_WARN, "SMU: failed to retrieve DPM weights");
			bzero(iodie->zi_dpm_weights,
			    sizeof (iodie->zi_dpm_weights));
		}
...
milan_fabric_init_tom(zen_ioms_t *ioms, void *arg)
{
	...
	if (fabric->zf_tom2 > MILAN_PHYSADDR_IOMMU_HOLE_END) {
...
milan_fabric_init_nbif_dev_straps(zen_nbif_t *nbif, void *arg)
{
	...
	for (uint8_t funcno = 0; funcno < nbif->zn_nfuncs; funcno++) {
		 ...
		 * over time.
		 */
		if ((func->zne_flags & ZEN_NBIF_F_NO_CONFIG) != 0) {
			continue;
		}
...
{
	bool ret = true;
	milan_dxio_impl_t *iofw = iodie->zi_iofw_impl;
	zen_dxio_platform_t *plat = iofw->mdc_conf;
	...
	for (uint_t i = 0; i < plat->zdp_nengines; i++) {
		...
		if (en->zde_type != ZEN_FW_ENGINE_PCIE)
			continue;
...
milan_fabric_setup_pcie_core_dbg(zen_pcie_core_t *pc, void *arg)
{
	for (uint16_t portno = 0; portno < pc->zpc_nports; portno++) {
		...
		if (port->zpp_flags & ZEN_PCIE_PORT_F_MAPPED) {
			 ...
			 * interest.
			 */
			laneno = port->zpp_engine->zde_start_lane -
	...
	for (;;) {
		...
		case MILAN_DXIO_DATA_TYPE_SM:
			cmn_err(CE_CONT, "?Socket %u LISM 0x%x->0x%x\n",
			    soc->zs_socno, iodie->zi_state, reply.mds_arg0);
			iodie->zi_state = reply.mds_arg0;
			switch (iodie->zi_state) {
			/*
			...
			case MILAN_DXIO_SM_CONFIGURED:
				milan_pcie_populate_dbg(&milan_fabric,
				    MPCS_DXIO_SM_CONFIGURED, iodie->zi_node_id);
		...
		case MILAN_DXIO_DATA_TYPE_RESET:
			...
			milan_pcie_populate_dbg(&milan_fabric,
			    MPCS_DXIO_SM_PERST_RESUME, iodie->zi_node_id);
 ...
 */
static int
milan_fabric_init_memlists(zen_ioms_t *ioms, void *arg)
{
	ioms_memlists_t *imp = &ioms->zio_memlists;
 ...
 */
static void
milan_route_pci_bus(zen_fabric_t *fabric)
{
	zen_iodie_t *iodie = &fabric->zf_socs[0].zs_iodies[0];
	uint_t inst = iodie->zi_ioms[0].zio_comp_id;
...
static int
milan_io_ports_allocate(zen_ioms_t *ioms, void *arg)
{
	int ret;
	...
	mri->mri_limits[mri->mri_cur] = mri->mri_bases[mri->mri_cur] +
	    mri->mri_per_ioms - 1;
	mri->mri_dests[mri->mri_cur] = ioms->zio_fabric_id;
 ...
 */
static int
milan_io_ports_assign(zen_iodie_t *iodie, void *arg)
{
	milan_route_io_t *mri = arg;
 ...
 */
static int
milan_mmio_allocate(zen_ioms_t *ioms, void *arg)
{
	int ret;
	 ...
	 */
	mrm->mrm_dests[mrm->mrm_cur] = ioms->zio_fabric_id;
	if (gen_base32 != 0) {
		ret = xmemlist_add_span(&imp->im_pool,
 ...
 * MILAN_PHYSADDR_MMIO_END. This is the zen_fabric_t's zf_mmio64_base member.
 *
...
milan_fabric_init_bridges(zen_pcie_port_t *port, void *arg)
{
	...
	if ((port->zpp_flags & ZEN_PCIE_PORT_F_MAPPED) != 0) {
		...
		lt = port->zpp_engine->zde_config.zdc_pcie.zdcp_link_train;
...
milan_fabric_init_pcie_core(zen_pcie_core_t *pc, void *arg)
{
	...
	val = milan_pcie_core_read(pc, reg);
	val = PCIE_CORE_SDP_CTL_SET_PORT_ID(val, pc->zpc_sdp_port);
	val = PCIE_CORE_SDP_CTL_SET_UNIT_ID(val, pc->zpc_sdp_unit);
	milan_pcie_core_write(pc, reg, val);
...
{
	ddi_dma_attr_t attr;
	milan_hotplug_t *hp = &fabric->zf_hotplug;
	...
	for (uint_t i = 0; entry[i].se_slotno != SMU_HOTPLUG_ENT_LAST; i++) {
		...
		port->zpp_hp_smu_mask = entry[i].se_func.shf_mask;
		...
		hp->mh_table->smt_map[slot].shm_bridge = pc->zpc_coreno *
		    ZEN_PCIE_CORE_MAX_PORTS + port->zpp_portno;
	}
...
milan_hotplug_bridge_features(zen_pcie_port_t *port)
{
	...
	if (oxide_board_data->obd_board == OXIDE_BOARD_ETHANOLX) {
		if (port->zpp_hp_type == ZEN_FW_HP_ENTERPRISE_SSD) {
	...
	case ZEN_FW_HP_EXPRESS_MODULE_A:
		if ((port->zpp_hp_smu_mask & SMU_ENTA_ATTNSW) == 0) {
			feats |= PCIE_SLOTCAP_ATTN_BUTTON;
		}

		if ((port->zpp_hp_smu_mask & SMU_ENTA_EMILS) == 0 ||
		    (port->zpp_hp_smu_mask & SMU_ENTA_EMIL) == 0) {
			feats |= PCIE_SLOTCAP_EMI_LOCK_PRESENT;
		}

		if ((port->zpp_hp_smu_mask & SMU_ENTA_PWREN) == 0) {
			feats |= PCIE_SLOTCAP_POWER_CONTROLLER;
		}

		if ((port->zpp_hp_smu_mask & SMU_ENTA_ATTNLED) == 0) {
			feats |= PCIE_SLOTCAP_ATTN_INDICATOR;
		}

		if ((port->zpp_hp_smu_mask & SMU_ENTA_PWRLED) == 0) {
			feats |= PCIE_SLOTCAP_PWR_INDICATOR;
		}
		break;
	case ZEN_FW_HP_EXPRESS_MODULE_B:
		if ((port->zpp_hp_smu_mask & SMU_ENTB_ATTNSW) == 0) {
			feats |= PCIE_SLOTCAP_ATTN_BUTTON;
		}

		if ((port->zpp_hp_smu_mask & SMU_ENTB_EMILS) == 0 ||
		    (port->zpp_hp_smu_mask & SMU_ENTB_EMIL) == 0) {
			feats |= PCIE_SLOTCAP_EMI_LOCK_PRESENT;
		}

		if ((port->zpp_hp_smu_mask & SMU_ENTB_PWREN) == 0) {
			feats |= PCIE_SLOTCAP_POWER_CONTROLLER;
		}

		if ((port->zpp_hp_smu_mask & SMU_ENTB_ATTNLED) == 0) {
			feats |= PCIE_SLOTCAP_ATTN_INDICATOR;
		}

		if ((port->zpp_hp_smu_mask & SMU_ENTB_PWRLED) == 0) {
			feats |= PCIE_SLOTCAP_PWR_INDICATOR;
		}
		break;
	default:
...
milan_hotplug_port_init(zen_pcie_port_t *port, void *arg)
{
	 ...
	 */
	if ((port->zpp_flags & ZEN_PCIE_PORT_F_HOTPLUG) == 0 ||
	    port->zpp_hp_type == ZEN_FW_HP_PRESENCE_DETECT) {
		return (0);
	}
...
{
	pc->zpc_dbg = kmem_zalloc(
	    MILAN_PCIE_DBG_SIZE(milan_pcie_core_dbg_nregs), KM_SLEEP);
	pc->zpc_dbg->mpd_nregs = milan_pcie_core_dbg_nregs;

	for (uint_t rn = 0; rn < pc->zpc_dbg->mpd_nregs; rn++) {
		milan_pcie_reg_dbg_t *rd = &pc->zpc_dbg->mpd_regs[rn];
...
{
	port->zpp_dbg = kmem_zalloc(
	    MILAN_PCIE_DBG_SIZE(milan_pcie_port_dbg_nregs), KM_SLEEP);
	port->zpp_dbg->mpd_nregs = milan_pcie_port_dbg_nregs;

	for (uint_t rn = 0; rn < port->zpp_dbg->mpd_nregs; rn++) {
		milan_pcie_reg_dbg_t *rd = &port->zpp_dbg->mpd_regs[rn];
...
milan_fabric_init(void)
{
	 ...
	 */
	zen_fabric_walk_ioms(fabric, milan_fabric_init_memlists, NULL);
	...
	zen_fabric_walk_nbif(fabric, milan_fabric_init_arbitration_nbif, NULL);
	zen_fabric_walk_ioms(fabric, milan_fabric_init_sdp_control, NULL);
	zen_fabric_walk_nbif(fabric, milan_fabric_init_nbif_syshub_dma, NULL);
