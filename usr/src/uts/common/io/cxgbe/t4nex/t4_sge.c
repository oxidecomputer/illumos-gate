 ...
 */
static inline void
t4_rx_fill_meoi(mblk_t* mp, struct cpl_rx_pkt *cpl, uint32_t chip_version)
{
	...
	/*
	 * ip_frag is set when either we have more fragments, or a nonzero
	 * fragment offset. To correctly infer the MEOI_L3_FRAG_MORE or
	 * MEOI_L3_FRAG_OFFSET flags, mac_ether_offload_info will eventually
	 * just reparse L3.
	 */
