...
typedef enum tfport_runstate {
	TFPORT_RUNSTATE_INIT,
	TFPORT_RUNSTATE_DLS,
	TFPORT_RUNSTATE_STOPPED,
...
#define	TFPORT_INIT_SOURCE_OPENED	0x01
#define	TFPORT_INIT_MAC_REGISTER	0x02
#define	TFPORT_INIT_INDEXED		0x04
#define	TFPORT_INIT_DEVNET		0x08
