...
void mac_perim_enter_by_mch(mac_client_handle_t mch, mac_perim_handle_t *mphp)
{
...
void
mac_tx_client_condemn(mac_client_impl_t *mcip)
{
	i_mac_tx_client_quiesce(mcip, SRS_CONDEMNED, false);
}
