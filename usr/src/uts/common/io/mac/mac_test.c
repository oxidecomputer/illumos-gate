...
/*
 * This file accesses `dblk_t`'s inner packet info representation for testing
 * purposes and to implement convenience methods on such data. This #define
 * exposes that underlying representation.
 */
