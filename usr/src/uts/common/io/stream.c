...
/*
 * This file needs to initialise and clear the inner representation for stored
 * packet info within `dblk_t`s. This #define exposes the underlying
 * representation. This should be opaque to all but streams itself and dedicated
 * parts of MAC.
 */
