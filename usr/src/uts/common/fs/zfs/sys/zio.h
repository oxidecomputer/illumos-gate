...
#define	ZIO_FLAG_VDEV_INHERIT	(ZIO_FLAG_DONT_QUEUE - 1)
	 ...
	 */
	ZIO_FLAG_DONT_QUEUE	= 1 << 20,	/* must be first for INHERIT */
	ZIO_FLAG_DONT_PROPAGATE	= 1 << 21,
	ZIO_FLAG_IO_BYPASS	= 1 << 22,
	ZIO_FLAG_IO_REWRITE	= 1 << 23,
	ZIO_FLAG_RAW_COMPRESS	= 1 << 24,
	ZIO_FLAG_RAW_ENCRYPT	= 1 << 25,
	ZIO_FLAG_GANG_CHILD	= 1 << 26,
	ZIO_FLAG_DDT_CHILD	= 1 << 27,
	ZIO_FLAG_GODFATHER	= 1 << 28,
	ZIO_FLAG_NOPWRITE	= 1 << 29,
	ZIO_FLAG_REEXECUTED	= 1 << 30,
	ZIO_FLAG_DELEGATED	= 1 << 31,
};
