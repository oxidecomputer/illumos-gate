...
extern void mac_resource_set(mac_client_handle_t, uint16_t, mac_resource_add_t,
    void *);
...
extern void mac_resource_set_common(mac_client_handle_t, uint16_t,
...
extern void mac_client_poll_disable(mac_client_handle_t, const uint16_t);
