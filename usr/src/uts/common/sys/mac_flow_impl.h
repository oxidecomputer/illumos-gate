...
struct flow_entry_s {					/* Protected by */
	...
	/*
	 * The list of all SRSes, logical and complete, which have this flow
	 * entry set as their srs_flent.
	 *
	 * Kstats and related should take a read on this list. Datapath setup
	 * should fold any stats back into fe_match_* and fe_act_* while holding
	 * a write lock to prevent double counting.
	 */
	krwlock_t	fe_srs_list_lock;
	list_t		fe_srs_list;
