...
typedef struct {
	 ...
	 * must still deliver to `ftex_srs` even if the action is to delegate
	 * to have the SRS perform traffic shaping.
	 */
...
extern void	mac_flow_specialise_match(mac_flow_match_t *, const bool);
