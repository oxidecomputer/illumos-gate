...
static void prt_ddm_hdr(int flags, struct ip6_ddm *ddm);
    ...
    int *fraglen)
{
	...
	while (is_extension_header) {
		...
		case IPPROTO_FRAGMENT:
			...
			break;
		case IPPROTO_DDM:
			ddm_header = (struct ip6_ddm *)data_ptr;
...
static void
prt_ddm_hdr(int flags, struct ip6_ddm *ddm)
{
	int i;
	ddm_element_t *dde;
