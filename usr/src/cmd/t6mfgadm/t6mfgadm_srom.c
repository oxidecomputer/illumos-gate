 ...
 * appears to be two different copies of this information. The information in
 * each copy actually seems to vary and change. As such, we treat each different
 * instance (two per function) as distinct. See the details srom regions
 * information in libt6mfg for more information.
 *
